...
`eval/analysis/kld564-paired-q3ks.json` (sha256
...
`final_mean_kld` fields (0.28727, 0.29591) tie the per-chunk pairs
back to the published sidecar aggregates.
...
## Flagged: derived numbers with a trivial or render-time derivation
