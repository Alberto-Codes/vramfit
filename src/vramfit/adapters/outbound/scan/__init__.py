...
This package is the one place vramfit touches torch and transformers
(ADR-0005, ADR-0008). Nothing here is imported at CLI startup — the
scan command imports [vramfit.adapters.outbound.scan.meter][] lazily,
...
See Also:
    - [vramfit.ports.outbound][]: `DamageMeter`, the port these
      adapters implement.
    - [vramfit.adapters.inbound.cli_scan][]: The command that drives
      them.
"""
