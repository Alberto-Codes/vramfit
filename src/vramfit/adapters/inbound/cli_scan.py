...
def scan(
    ...
    unpinned, so one corpus through two tokenizers still measures
    two token counts. The fingerprint folds that count, so a
    tokenizer change alone still refuses a checkpoint.
