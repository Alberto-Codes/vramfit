...
def pack(
    ...
    recipe's full override composition is checked before any stage
    runs — that catches an unmappable pair and a protection under
    a second root (#367) — and a protected recipe
    ...
    # An unmappable recipe must fail here, in milliseconds — not
